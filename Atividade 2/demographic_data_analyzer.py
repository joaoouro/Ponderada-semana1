...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round(df.loc[higher_education, 'salary'].value_counts(normalize=True)['>50K'] * 100, 1)
    lower_education_rich = round(df.loc[lower_education, 'salary'].value_counts(normalize=True)['>50K'] * 100, 1)
